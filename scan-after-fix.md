Starting Nmap 7.98 ( https://nmap.org ) at 2025-11-23 11:40 -0500
Nmap scan report for 10.0.0.190
Host is up (0.027s latency).
Not shown: 997 filtered tcp ports (no-response)
PORT     STATE SERVICE VERSION
22/tcp   open  ssh     OpenSSH 8.4p1 Raspbian 5+deb11u5 (protocol 2.0)
| vulners: 
...
80/tcp   open  http    Apache httpd 2.4.65 ((Raspbian))
| vulners: 
...
|     	CNVD-2024-33815	5.3	https://vulners.com/cnvd/CNVD-2024-33815
...
|_http-server-header: Apache/2.4.65 (Raspbian)
...
Nmap done: 1 IP address (1 host up) scanned in 537.61 seconds
